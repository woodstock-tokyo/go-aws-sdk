## dynamo [![GoDoc](https://godoc.org/github.com/woodstock-tokyo/go-aws-sdk/dynamo?status.svg)](https://godoc.org/github.com/woodstock-tokyo/go-aws-sdk/dynamo)

`import "github.com/woodstock-tokyo/go-aws-sdk/dynamo"`
...
- [`dynamo.Marshaler`](https://godoc.org/github.com/woodstock-tokyo/go-aws-sdk/dynamo#Marshaler) and [`dynamo.Unmarshaler`](https://godoc.org/github.com/woodstock-tokyo/go-aws-sdk/dynamo#Unmarshaler)
...
In order to use dynamodbattribute's encoding facilities, you must wrap objects passed to dynamo with [`dynamo.AWSEncoding`](https://godoc.org/github.com/woodstock-tokyo/go-aws-sdk/dynamo#AWSEncoding). Here is a quick example:
...
```bash
DYNAMO_TEST_REGION=us-west-2 go test github.com/woodstock-tokyo/go-aws-sdk/dynamo/... -cover
```
...
```bash
DYNAMO_TEST_REGION=us-west-2 DYNAMO_TEST_ENDPOINT=http://localhost:8000 go test github.com/woodstock-tokyo/go-aws-sdk/dynamo/... -cover
```
